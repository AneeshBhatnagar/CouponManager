...
public class StoreCoupons extends Fragment {
    ...
    public void onStart() {
        ...
        List<Coupon> couponList = db.getStoreCoupons(store.getId());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_used_coupons, container, false);
